...
inputel.on('focus',win.id,evhan_input_focus);inputel.on('blur',win.id,evhan_input_blur);inputel.data('winid',win.id);win.historypos=win.history.length;win.needscroll=true;}
...
width=maxwidth;inputel.css({position:'absolute',left:xpos+'px',top:pos.top+'px',width:width+'px'});if(!win.inputel)
...
width=1;inputel.css({position:'absolute',left:'0px',top:'0px',width:width+'px'});if(!win.inputel)
